...
class movieAdapterLittleView extends RecyclerView.Adapter<movieHolderLittleView> {

    private Context mContext;
    private List<Movie> movies;


    public movieAdapterLittleView(Context context, List<Movie> mov) {
        mContext = context;
        movies = mov;
    ...
    @Override
    public movieHolderLittleView onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        final Context context = viewGroup.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.mainactivity_littleView, viewGroup, false);


        return new movieHolderLittleView(view);
    }

    @Override
    public void onBindViewHolder(movieHolderLittleView holder, int position) {
